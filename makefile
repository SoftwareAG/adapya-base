...
release:
    ...
    rem call prune.bat
    rem del prune.bat
    $(SED) -i "s/v.r.l/$(VRL)/" setup.py adapya\base\*.py adapya\base\doc\*.py adapya\base\doc\*.rst
    $(SED) -i "s/ThisYear/$(THISYEAR)/" adapya\base\*.py  adapya\base\doc\*.py adapya\base\doc\*.rst
